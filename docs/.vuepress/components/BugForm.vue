...
<div class="container-lg clearfix mb-6">
<p class="h3 text-shadow-light">Desktop</p>
  <div class="col-4 float-left">
    <label class="tooltipped tooltipped-s text-small" aria-label="Indica il Sistema Operativo in uso" for="os">Sistema Operativo
<input id="os" class="form-control input-monospace input-block input-sm" type="text" placeholder="[e.g. iOS]" aria-label="OS" />
</label>
  </div>
  <div class="col-4 float-left px-2">
    <label class="tooltipped tooltipped-s text-small" aria-label="Indica il Browser usato" for="browser">Browser
<input id="browser" class="form-control input-monospace input-block input-sm" type="text" placeholder="[e.g. chrome, safari]" aria-label="Browser" />
</label>
  </div>
  <div class="col-4 float-left">
    <label class="tooltipped tooltipped-s text-small" aria-label="Indica la versione" for="version">Versione
<input id="version" class="form-control input-monospace input-block input-sm" type="text" placeholder="[e.g. 2.2]" aria-label="Version" />
</label>
  </div>
</div>
...
<div class="container-lg clearfix mb-6">
     <p class="h3  text-shadow-light">Mobile</p>
    <div class="col-6 float-left pr-4 border-right">
        <label class="text-small" for="mobileos">Sistema Operativo
       <input id="mobileos" class="form-control input-monospace mb-2 input-sm input-block" type="text" placeholder="[e.g. iOS]" aria-label="OS" />
        </label>
        <label class="text-small"  for="mobiledevice">Dispositivo
       <input id="mobiledevice" class="form-control input-monospace mb-2 input-sm input-block" type="text" placeholder="[e.g. iPhone6]" aria-label="Device" />
        </label>
    </div>
    <div class="col-6 float-left pl-4">
       <label class="text-small" for="mobilebrowser">Browser
<input id="mobilebrowser" class="form-control input-monospace mb-2 input-sm input-block" type="text" placeholder="[e.g. chrome, safari]" aria-label="Mobile Browser" />
</label>
 <label class="text-small" for="mobileversion">Versione
<input id="mobileversion" class="form-control input-monospace mb-2 input-sm input-block" type="text" placeholder="[e.g. 22]" aria-label="Mobile Version" />
</label>
</div>
</div>
