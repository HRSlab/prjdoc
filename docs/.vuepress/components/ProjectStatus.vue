    ...
    <div class="container-md clearfix">
      ...
      <div class="col-md-2 col-12 float-left">
        <div class="f5-light m-2 text-center">
          ...
          <span
            title="Status"
            class="IssueLabel p-2 color-bg-warning-inverse color-text-secondary"
            v-if="$frontmatter.Status  === 'On Hold'"
          >
          ...
          <span
            title="Status"
            class="IssueLabel p-2 color-bg-success-inverse color-text-white"
            v-else-if="$frontmatter.Status  === 'In Progress'"
          >
          ...
          <span
            title="Status"
            class="IssueLabel p-2 color-bg-danger-inverse color-text-white"
            v-else-if="$frontmatter.Status  === 'Delayed'"
          >
            <svg class="octicon" viewBox="0 0 16 16" width="16" height="16">
              <path
                fill-rule="evenodd"
          ...
          <span
            title="Status"
            class="IssueLabel p-2 color-bg-canvas-inverse color-text-white"
            v-else-if="$frontmatter.Status  === 'Blocked'"
          >
            <svg class="octicon" viewBox="0 0 16 16" width="16" height="16">
              <path
                fill-rule="evenodd"
          ...
          <span
            title="Status"
            class="IssueLabel p-2 color-bg-info-inverse color-text-white"
            v-else
          >
